 ...
 * @param clientId - Block client ID.
 */
export function selectPreviousBlock(
	clientId: string
): IterableIterator< void >;
...
/**
 * Signals that the next block change should be marked explicitly as not persistent.
 */
export function __unstableMarkNextChangeAsNotPersistent(): void;

/**
 * Signals that the last block change should be marked explicitly as not persistent.
 */
export function __unstableMarkLastChangeAsPersistent(): void;
